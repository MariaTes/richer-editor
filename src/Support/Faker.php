...
class Faker
{
    ...
    {
        return RichContentRenderer::make($this->output)->toJson();
    }

    public function asText(): string
    {
        return RichContentRenderer::make($this->output)->toText();
    }

    public function asMarkdown(): string
    {
        return RichContentRenderer::make($this->output)->toMarkdown();
    }
}
